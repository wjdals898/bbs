			...
			<div class="container">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn btn-primary btn-pull" href="Userbbs.jsp?writerID=<%=list.get(i).getFriendID()%>">★</a></td>
					</tr>
					<%
						}
					%>
				...
				<p>
					<a class="btn btn-primary btn-pull"href="friendlistModify.jsp" role="button">친구 목록 수정</a>
					<a class="btn btn-primary btn-pull"href="friendhidelist.jsp" role="button">숨겨진 친구 목록</a>
				</p>
			</div>
		</div>
	</div>
