...
<body>
	<%
		...
		userEmail = user.getUser(userID).getUserEmail();
	...
	<%
		...
		ArrayList<User> sList = userDAO.emailSearchList(request.getParameter("content"), userID);
		int n = sList.size();
	%>
		...
		<div class="jumbotron" style="margin:0;">
			<div class="container">
				...
				<div style="display:flex; justify-content:center;">
					<form method="post" action="searchAction.jsp?option=4" style="display:flex; justify-content:left; margin-top:30px;">
						...
						<tbody>
							<%
								for(int i=0; i<sList.size(); i++){
									if(!sList.get(i).getUserEmail().equals(userEmail)){
							%>
							<tr>
