...
<body>
	<%
		...
		userPhone = user.getUser(userID).getUserPhone();
	...
	<%
		...
		ArrayList<User> sList = userDAO.phoneSearchList(request.getParameter("content"), userID);
		int n = sList.size();
	%>
		...
		<div class="jumbotron" style="margin:0;">
			<div class="container">
				...
				<div style="display:flex; justify-content:center;">
					<form method="post" action="searchAction.jsp?option=3" style="display:flex; justify-content:left; margin-top:30px;">
						...
						<tbody>
							<%
								for(int i=0; i<sList.size(); i++){
									if(!sList.get(i).getUserPhone().equals(userPhone)){
							%>
							<tr>
