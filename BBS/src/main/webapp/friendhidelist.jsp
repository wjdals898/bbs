			...
			<div class="container">
				...
				<thead>
					<tr>
						...
						<th style="background-color : #eeeeee; text-align: center;">숨김 취소 / 삭제</th>
					</tr>
				</thead>
				<tbody>
					<%
						FriendDAO friendDAO = new FriendDAO();
						ArrayList<Friend> list = friendDAO.getHideList(userID);
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary btn-pull" href="friendlistdisplayAction.jsp?friendID=<%=list.get(i).getFriendID() %>" role="button">숨김 취소</a>
							<a class="btn btn-primary btn-pull" href="friendhidelistdeleteAction.jsp?friendID=<%=list.get(i).getFriendID()%>" role="button">삭제</a>
						</td>
					</tr>
					<%
						}
				...
				<p><a class="btn btn-primary btn-pull"href="friendlist.jsp" role="button">친구목록</a></p>
			</div>
		</div>
	</div>
